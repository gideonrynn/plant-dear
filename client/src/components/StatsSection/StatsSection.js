...
const StatsSection = () => {
    ...
    return (
      <Box animation="fadeIn" gap="small" wrap="true">
        <Grid
          rows={['auto', 'auto', 'auto']}
          columns={['auto', 'auto']} 
        ...
        <Card 
          ...
          <CardBody pad="medium" ><p className="stats">48</p></CardBody>
          <CardFooter pad={{horizontal: "small"}} background="light-3" href="#">   
            <a href="#"><i>All plant dears</i></a>
          </CardFooter>
        </Card>

        <Card height="small" width="small" background="neutral-2">
          {/* <CardHeader pad="medium">Header</CardHeader> */}
          <CardBody pad="medium"><p className="stats">4</p></CardBody>
          <CardFooter pad={{horizontal: "small"}} background="light-3" href="#">   
            <a href="#"><i>Watchlist</i></a>
          </CardFooter>
        </Card>

        <Card height="small" width="small" background="neutral-4">
          {/* <CardHeader pad="medium">Header</CardHeader> */}
          <CardBody pad="medium" className="stats">17</CardBody>
          <CardFooter pad={{horizontal: "small"}} background="light-3" href="#">   
            <a href="#"><i>Hardiness watch</i></a>
          </CardFooter>
        </Card>

        <Card height="small" width="small" background="neutral-3">
          {/* <CardHeader pad="medium">Header</CardHeader> */}
          <CardBody pad="medium" className="stats">12</CardBody>
          <CardFooter pad={{horizontal: "small"}} background="light-3" href="#">   
